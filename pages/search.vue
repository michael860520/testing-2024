...
function getQueryAsString(queryValue: string | string[] | null | undefined): string {
...
const searchValue = ref(getQueryAsString(route.query.q as string | string[] | null | undefined))
const inputValue = ref('')

watch(() => route.query.q, (newQuery) => {
  const queryAsString = getQueryAsString(newQuery as string | string[] | null | undefined)
  ...
  <div class="flex flex-col gap-4 p-6">
    <div class="text-center">
      ...
      <template v-if="searchValue">
        ...
        <button
          class="mb-4 bg-red-500 text-white rounded px-4 py-2"
          @click="clearSearch"
        >
          {{ $t('ClearSearch') }}
        </button>
        <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4">
          <div v-for="i in 12" :key="i" class="bg-white rounded-lg shadow-md overflow-hidden">
            ...
            <div class="p-4">
              ...
              <NuxtLink
                :to="`/products/${i}`"
                class="mt-4 bg-blue-500 text-white rounded px-4 py-2 inline-block"
              >
                View
              </NuxtLink>
            </div>
      ...
      <template v-else>
        ...
        <div class="flex justify-center items-center">
          ...
          <NuxtLink
            ...
            class="ml-2 bg-blue-500 text-white rounded px-4 py-2"
          >
            {{ $t('Search') }}
          </NuxtLink>
        </div>
    ...
    <div class="text-center">
      <NuxtLink
        class="text-sm bg-slate-400 px-4 py-2 rounded-lg inline-block"
        to="/"
      >
        {{ $t('Back') }}
      </NuxtLink>
